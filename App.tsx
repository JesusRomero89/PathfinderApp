...
const initialSkill = (): SkillData => ({ prof: 'untrained', item: 0, armorPen: 0 });
const initialSave = (p: Proficiency = 'untrained'): SavingThrowData => ({ prof: p, item: 0 });

const defaultFeatsText = 
...
export default function App() {
  ...
  const getProfBonus = (prof: Proficiency) => {
    return COMPETENCE_BONUS[prof] > 0 ? COMPETENCE_BONUS[prof] + character.level : 0;
  };
